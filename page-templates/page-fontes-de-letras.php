...
<article class="content-article">
  ...
  <p><strong>Efeitos (espelho, tachado, sublinhado)</strong>: aplicam uma decoração sobre o texto em vez de trocar o desenho da letra em si: inverter a leitura (espelhado), riscar (tachado ~texto~, feito ao combinar cada letra com um caractere de combinação Unicode que desenha uma linha sobre ela) ou sublinhar. Usados com moderação, funcionam bem para chamar atenção em uma palavra específica dentro de uma frase maior, mas tendem a prejudicar a leitura quando aplicados a um texto inteiro, já que exigem mais esforço visual do leitor.</p>
